<div>
    <div class="pagetitle">
        <h1 class="fw-bold text-primary">Profil Koordinator</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('koordinator.dashboard') }}" class="text-decoration-none">Dashboard</a></li>
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body text-center p-4">
                    ...
                    <span class="badge bg-warning bg-gradient px-3 py-2 mb-3">
